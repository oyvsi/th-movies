...
<?php //print_r($userInfo);
	echo $this->Form->create('User', array('id' => 'EditUser', 'url' => array('controller' => 'users', 'action' => 'edit/' . $user['id']), 'type' => 'put'));
	echo $this->Form->input('id', array('id' => 'id', 'type' => 'hidden', 'value' => $user['id']));
